...
// In production, VITE_API_URL points to your deployed backend (e.g., https://your-backend.railway.app/api)
// In local dev, the Vite proxy handles /api -> localhost:8080
